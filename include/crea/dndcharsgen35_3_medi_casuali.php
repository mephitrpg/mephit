...
<td align=left><input class="txt" name=punNobonusFOR size=2 value="'.$for.'" readonly></td>
...
<td align=left><input class="txt" name=punNobonusDES size=2 value="'.$des.'" readonly></td>
...
<td align=left><input class="txt" name=punNobonusCOS size=2 value="'.$cos.'" readonly></td>
...
<td align=left><input class="txt" name=punNobonusINT size=2 value="'.$int.'" readonly></td>
...
<td align=left><input class="txt" name=punNobonusSAG size=2 value="'.$sag.'" readonly></td>
...
<td align=left><input class="txt" name=punNobonusCAR size=2 value="'.$car.'" readonly></td>
